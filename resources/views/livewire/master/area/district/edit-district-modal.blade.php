    ...
    <x-modal name="show" wire:model="show">
        ...
        <x-slot name="body">
            <div class="flex flex-col lg:flex-row mt-1 gap-4">
                ...
                <div class="w-full md:w-2/3">
                    <div class="mt-1 relative rounded-xs shadow-sm">
                        <x-form.input name="short_name" wire:model="short_name" />
                    </div>
                </div>
            </div>
            <div class="flex flex-col lg:flex-row mt-1 gap-4">
                <div class="w-full md:w-2/3">
                    <div class="mt-1 relative rounded-xs shadow-sm">
                        <x-form.input name="ref_code" wire:model="ref_code" />
                    </div>
                </div>
                <div class="w-full md:w-2/3">
                    <div class="mt-1 relative rounded-xs shadow-sm">
                        <x-form.input name="lg_code" wire:model="lg_code" />
                    </div>
                </div>
            </div>
            <div class="flex flex-col lg:flex-row mt-1 gap-4">
                <div class="w-full md:w-1/2">
                    <div class="mt-1 relative rounded-md">
                        <x-form.select name="state" wire:model="state">
