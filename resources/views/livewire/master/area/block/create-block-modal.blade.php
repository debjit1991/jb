    ...
    <x-modal wire:model="show">
        ...
        <x-slot name="body">
            <div class="flex flex-col lg:flex-row mt-1 gap-4">
                <div class="w-full md:w-1/2 mt-1 text-gray-700">
                    <div class="mt-1 relative rounded-md">
                        <x-form.input type="text" name="name" id="name" class="block w-full sm:text-sm"
                            placeholder="Enter Block Name" wire:model.lazy="name" autocomplete="off" />
                    </div>
                </div>
                <div class="w-full md:w-1/2 mt-1 text-gray-700">
                    <div class="mt-1 relative rounded-md">
                        <x-form.input type="text" name="lg_code" id="lg_code" class="block w-full sm:text-sm"
            ...
            <div class="flex flex-col md:flex-row w-full mt-1 gap-4">
                <div class="w-full md:w-1/2 mt-1 text-gray-700">
                    <div class="mt-1 relative rounded-md">
                        <x-form.input type="text" name="ref_code" id="ref_code" class="block w-full sm:text-sm"
